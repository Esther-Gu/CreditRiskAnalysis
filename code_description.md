...
```
I am going to combine the "unknown" categories in the 'EDUCATION' variable. Because from data description, we know 4=others, 5=unknown, 6=unknown. I replaced categories 0, 5, and 6 with 4 (indicating "others").
```python
